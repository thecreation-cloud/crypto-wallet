...
import { EVMAdapter, type EVMAdapterConfig } from "./adapter.js";

type Override = Partial<EVMAdapterConfig>;
...
export function createEthereumAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
...
export function createBNBAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: bsc,
    walletChainId: "bnb",
...
export function createPolygonAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: polygon,
...
export function createAvalancheAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: avalanche,
...
export function createArbitrumAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: arbitrum,
...
export function createOptimismAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: optimism,
...
export function createBaseAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: base,
    walletChainId: "base",
...
export function createFantomAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: fantom,
...
export function createZkSyncAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: zksync,
...
export function createCronosAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: cronos,
...
export function createGnosisAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: gnosis,
...
export function createCeloAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: celo,
    walletChainId: "celo",
...
export function createSepoliaAdapter(rpcUrl?: string, override?: Override): EVMAdapter {
  return new EVMAdapter({
    chain: sepolia,
