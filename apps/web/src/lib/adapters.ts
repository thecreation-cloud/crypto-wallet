...
export const adapters: ChainAdapter[] = [
  createEthereumAdapter(e("NEXT_PUBLIC_ETH_RPC_URL")),
  createBNBAdapter(e("NEXT_PUBLIC_BNB_RPC_URL")),
  createPolygonAdapter(e("NEXT_PUBLIC_POLYGON_RPC_URL")),
  createAvalancheAdapter(e("NEXT_PUBLIC_AVAX_RPC_URL")),
  createArbitrumAdapter(e("NEXT_PUBLIC_ARB_RPC_URL")),
  createOptimismAdapter(e("NEXT_PUBLIC_OP_RPC_URL")),
  createBaseAdapter(e("NEXT_PUBLIC_BASE_RPC_URL")),
  createFantomAdapter(e("NEXT_PUBLIC_FTM_RPC_URL")),
  createZkSyncAdapter(e("NEXT_PUBLIC_ZKSYNC_RPC_URL")),
  createCronosAdapter(e("NEXT_PUBLIC_CRO_RPC_URL")),
  createGnosisAdapter(e("NEXT_PUBLIC_GNO_RPC_URL")),
  createCeloAdapter(e("NEXT_PUBLIC_CELO_RPC_URL")),
